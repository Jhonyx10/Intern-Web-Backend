...
{
    /**
     * Authenticate staff portal users (email + password) via Sanctum token.
     */
    ...
    private function userPayload(User $user): array
    {
        return [
            ...
            'section' => $user->hasRole('coordinator') ? $this->sectionPayload($user) : null,
        ];
    }
     ...
     * @return array<string, mixed>|null
     */
    private function sectionPayload(User $user): ?array
    {
